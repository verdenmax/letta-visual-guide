...
<p><span class="mono">chat_completion_proxy.py::generate_grammar_and_documentation</span>——运行时动态生成 GBNF（底层调 <span class="mono">grammars/gbnf_grammar_generator.py::generate_gbnf_grammar_and_documentation</span>）。</p>
...
<p><span class="mono">chat_completion_proxy.py::generate_grammar_and_documentation</span> — dynamically generates GBNF at runtime (delegating to <span class="mono">grammars/gbnf_grammar_generator.py::generate_gbnf_grammar_and_documentation</span>).</p>
