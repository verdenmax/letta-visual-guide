...
<tr><td class="mono">Literal[...]</td><td class="mono">enum</td><td>enumerated allowed values</td></tr>
...
<div class="note info"><span class="ni">📌</span><span class="nx">Summing up the type section: use basic types when you can, use <span class="mono">Optional</span> for "optional", use <span class="mono">Literal</span> for "one of several", use a Pydantic model for "a set of fields" — steer clear of bare <span class="mono">Dict</span> and <span class="mono">Union</span> and you sidestep the vast majority of errors.</span></div>
<div class="cute"><div class="row">
  <span class="emoji">📝</span><span class="lab">docstring</span>
