...
<tr><td>对话历史 <span class="mono">conversation history</span></td><td>所有来往消息逐字、按时间排序的完整记录——做摘要之前的原始底料，正是 recall memory 的本体。</td><td><a href="11-recall-memory.html">第 11 课</a></td></tr>
</table>
...
<tr><td>数据源 <span class="mono">source</span> / <span class="mono">RAG</span></td><td>上传的文档被切块、嵌入、存成可检索的外部知识来源。</td><td><a href="29-data-sources-rag.html">第 29 课</a></td></tr>
...
<tr><td><span class="mono">FileAgent</span> / <span class="mono">FileBlock</span></td><td><span class="mono">FileAgent</span> 管每个 agent 的开文件与限额，<span class="mono">FileBlock</span> 则是把打开的文件原文只读塞进上下文的那块（默认最多开 5 个）。</td><td><a href="29-data-sources-rag.html">第 29 课</a></td></tr>
...
<tr><td><span class="mono">conversation history</span></td><td>The verbatim, time-ordered record of every message — the raw substrate before any summarization, exactly what recall memory is.</td><td><a href="11-recall-memory.html">Lesson 11</a></td></tr>
</table>
...
<h2>⑥ Server and persistence: punching down through three layers</h2>
<table class="t">
<tr><th>Term</th><th>In one line</th><th>Lesson</th></tr>
...
<tr><td>data <span class="mono">source</span> / <span class="mono">RAG</span></td><td>Uploaded documents chunked, embedded, and stored as a searchable external knowledge source.</td><td><a href="29-data-sources-rag.html">Lesson 29</a></td></tr>
...
<tr><td><span class="mono">FileAgent</span> / <span class="mono">FileBlock</span></td><td><span class="mono">FileAgent</span> manages an agent's open files and the cap; <span class="mono">FileBlock</span> is the block that drops an opened file's raw text read-only into context (up to 5 open by default).</td><td><a href="29-data-sources-rag.html">Lesson 29</a></td></tr>
